...
not_run: if (WebUI.verifyElementVisible(findTestObject('Object Repository/AIMS/Components/Create/Asset Aid to Navigation/Page_AIMS-AMX - Home/span_Home'), 
...
AMXidDep = WebUI.getAttribute(findTestObject('AIMS/Components/Create/Verifications/Page_AIMS-AMX - Home/Page_AIMS-AMX - Home/AMXid2'), 
    'value')

GlobalVariable.AMXidDep = AMXidDep

//Creates a variable of the full asset name created.  Allows for validation and subsequent searching and deleting.
LongID = (('Automation (' + AMXidDep) + ')')
