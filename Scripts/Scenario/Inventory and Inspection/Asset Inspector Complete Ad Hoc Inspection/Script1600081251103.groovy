...
WebUI.callTestCase(findTestCase('Components/Create/Create Asset'), [('AssetType') : findTestData('Assets/Create Asset').getValue(
            1, 13), ('SubType') : findTestData('Assets/Asset Sub Types/Structure ST').getValue(1, 32)], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Components/Inspections/Complete Inspection'), [('InspectionType') : findTestData('Inspections/Inspection Type').getValue(
            ...
            'Inspections/Inspection Type').getValue(3, 1), ('AssetSubType') : findTestData('Assets/Asset Sub Types/Structure ST').getValue(
            1, 32)], FailureHandling.STOP_ON_FAILURE)
