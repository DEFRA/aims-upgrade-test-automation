...
WebUI.callTestCase(findTestCase('Components/Create/Create Asset'), [('AssetType') : findTestData('Assets/Create Asset').getValue(
            1, 6), ('SubType') : findTestData('Assets/Asset Sub Types/Channel ST').getValue(1, 3)], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Components/Inspections/Complete Inspection'), [('InspectionType') : findTestData('Inspections/Inspection Type').getValue(
            1, 2), ('InspectionSchedule') : findTestData('Inspections/Inspection Type').getValue(2, 1), ('InspectionGroup') : findTestData(
            'Inspections/Inspection Type').getValue(3, 1), ('AssetSubType') : findTestData('Assets/Asset Sub Types/Channel ST').getValue(
