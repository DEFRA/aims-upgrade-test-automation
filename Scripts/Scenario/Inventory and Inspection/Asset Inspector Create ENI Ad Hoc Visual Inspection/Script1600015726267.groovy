...
WebUI.callTestCase(findTestCase('Components/Inspections/ENI Inspection'), [('InspectionType') : findTestData('Inspections/Inspection Type').getValue(
            1, 1), ('InspectionSchedule') : findTestData('Inspections/Inspection Type').getValue(2, 1), ('InspectionGroup') : findTestData(
            'Inspections/Inspection Type').getValue(3, 1)], FailureHandling.STOP_ON_FAILURE)
