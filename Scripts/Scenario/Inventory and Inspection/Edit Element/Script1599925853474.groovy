...
WebUI.callTestCase(findTestCase('Components/Create/Create Asset'), [('AssetType') : findTestData('Assets/Create Asset').getValue(
            1, 13), ('SubType') : findTestData('Assets/Asset Sub Types/Structure ST').getValue(1, 1)], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/Search/Search Asset'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/Create/Add Element'), [('ElementType') : findTestData('Assets/Element Items/Item Types').getValue(
            1, 1)], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Components/Edit/Edit Element'), [:], FailureHandling.STOP_ON_FAILURE)
